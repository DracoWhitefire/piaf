...
| `0x24` | Type IX Formula-Based Timing       | `supported_modes` with `cvt_algorithm` (CVT-RB1/RB2/RB3, RB-with-CVT-RB1/RB2) and `y420` flag from byte 0; **CVT-RB v1 and CVT-RB v2** fully expanded to `pixel_clock_khz` + blanking via `display_types::compute_type_ix_timing` (RB v3 pending) |
